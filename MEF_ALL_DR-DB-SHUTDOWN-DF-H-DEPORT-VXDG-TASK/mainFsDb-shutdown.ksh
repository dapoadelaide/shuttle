...
print ""
print "################################### [df -h|grep mef-|grep -v grep] #####################################################################################"

msg="Running 'df -h|grep mef-|grep -v grep' - 1 of 7 actions...[df -h|grep mef-|grep -v grep]"
msgOut
df -h|grep mef- | grep -v grep
...
msg="Running 'df -h|grep mef- |grep -v grep' again - 4 of 7 actions...[df -h|grep mef-|grep -v grep]"
msgOut
df -h|grep mef- |grep -v grep
rc=$?
if [ $rc -eq 0 ]; then
...
print "################################################# vgs|grep mefvg  after Deport ##################################################################"
msg="Running 'vgs' -  7 of 7 actions ...[ vgs|grep mefvg ]"
msgOut
vgs | grep mefvg
rc=$?
msg="Return Code [vgs|grep mefvg] [rc:$rc]"
msgOut
