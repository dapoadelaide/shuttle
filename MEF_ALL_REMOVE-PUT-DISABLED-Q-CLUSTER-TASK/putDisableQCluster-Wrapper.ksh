...
# executes the putDisableQCluster.ksh script that   #
...
# /var/mqm/scripts/putDisableQCluster.ksh  $1 $2
echo "Command: [su - mqm -c cd /var/mqm/scripts;  /var/mqm/scripts/putDisableQCluster.ksh $qmgr_name $file_name]"
su - mqm -c "cd /var/mqm/scripts; /var/mqm/scripts/putDisableQCluster.ksh $qmgr_name $file_name"
