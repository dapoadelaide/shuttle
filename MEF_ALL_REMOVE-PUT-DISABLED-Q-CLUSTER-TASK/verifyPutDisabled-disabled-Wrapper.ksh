...
echo "Command: [su - mqm -c cd /var/mqm/scripts; /var/mqm/scripts/verifyPutDisabled.ksh $qmgr_name $file_name]"
su - mqm -c "cd /var/mqm/scripts; /var/mqm/scripts/verifyPutDisabled.ksh $qmgr_name $file_name"
