...
ECHO "Command: [su - mqm -c cd /var/mqm/scripts;  /var/mqm/scripts/statusQCluster.ksh $qmgr_name $cluster_name]"
su - mqm -c "cd /var/mqm/scripts; /var/mqm/scripts/statusQCluster.ksh $qmgr_name $cluster_name"
