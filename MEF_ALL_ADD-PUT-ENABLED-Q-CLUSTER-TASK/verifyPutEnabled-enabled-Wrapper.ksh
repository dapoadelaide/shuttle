...
# /var/mqm/scripts/verifyPutEnabled.ksh  $1 $2
echo "Command: [su - mqm -c cd /var/mqm/scripts;  /var/mqm/scripts/verifyPutEnabled.ksh $qmgr_name $file_name]"
su - mqm -c "cd /var/mqm/scripts; /var/mqm/scripts/verifyPutEnabled.ksh $qmgr_name $file_name"
