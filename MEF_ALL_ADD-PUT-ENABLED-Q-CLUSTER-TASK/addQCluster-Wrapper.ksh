...
#  /var/mqm/scripts/addQCluster.ksh  $1 $2 $3
echo "Command: [su - mqm -c cd /var/mqm/scripts; /var/mqm/scripts/addQCluster.ksh $qmgr_name $cluster_name $file_name]"
su - mqm -c "cd /var/mqm/scripts; /var/mqm/scripts/addQCluster.ksh $qmgr_name $cluster_name $file_name"
