...
# /var/mqm/scripts/parasoftRemoveQCluster.sh  $1 $2
echo "Command: [su - mqm -c cd /var/mqm/scripts;  /var/mqm/scripts/parasoftRemoveQCluster.sh $qmgr_name $file_name]"
su - mqm -c "cd /var/mqm/scripts; /var/mqm/scripts/parasoftRemoveQCluster.sh $qmgr_name $file_name"
