...
#####################################################
# PutDisableQCluster.ksh                            #
# ================================================= #
# Note:  This script must be executed as "mqm".     #
# ================================================= #
# This script is for a Tivoli Task.  The script     #
# executes the putDisableQCluster.sh script that   #
# must reside in /var/mqm/scripts.  This script will#
# change the PUT Status to Disabled for a list of   #
# queues from a file.                               #
# ================================================= #
# Parameters are:                                   #
...
# Updated for multi logging by PAdelaide - IBM/IRS - 05/19/2018
...
# /var/mqm/scripts/putDisableQCluster.sh  $1 $2
echo "Command: [su - mqm -c cd /var/mqm/scripts;  /var/mqm/scripts/parasoftPutDisableQCluster.sh $qmgr_name $file_name]"
su - mqm -c "cd /var/mqm/scripts; /var/mqm/scripts/parasoftPutDisableQCluster.sh $qmgr_name $file_name"
