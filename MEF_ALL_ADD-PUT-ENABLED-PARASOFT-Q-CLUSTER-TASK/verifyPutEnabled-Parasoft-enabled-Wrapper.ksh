...
# /var/mqm/scripts/parasoftVerifyPutEnableQCluster.sh  $1 $2
echo "Command: [su - mqm -c cd /var/mqm/scripts;  /var/mqm/scripts/parasoftVerifyPutEnableQCluster.sh $qmgr_name $file_name]"
su - mqm -c "cd /var/mqm/scripts; /var/mqm/scripts/parasoftVerifyPutEnableQCluster.sh $qmgr_name $file_name"
